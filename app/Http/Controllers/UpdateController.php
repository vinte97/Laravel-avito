...
class UpdateController extends Controller
{
    ...
    {
        $output = exec('python3 updateXML.py 2>&1');
        echo "<pre>$output</pre>";
    }

    public function updateYaml()
    {
        $output = system('python3 updateYAML.py 2>&1');
        echo "<pre>$output</pre>";
    }
    ...
    //         }
    //         $xmlContent1 = str_replace(['&ndash;', '&nbsp;'], ['&#8211;', '&#160;'], $response1->body());
    ...
    //         $xmlContent2 = str_replace(['&ndash;', '&nbsp;'], ['&#8211;', '&#160;'], $response2->body());
