...
XML_URL_1 = 'https://www.buszap.ru/get_price?p=219a76583bbd4991ade213a8b15b5808&FranchiseeId=9117065'
XML_URL_2 = 'https://www.buszap.ru/get_price?p=3dbb37d4f12242068faf72c2cf839c82&FranchiseeId=9117065'
...
def process_xml(xml_content):
    ...
    for ad in root.findall('offer'):
        ad_id = ad.get('id')
        articul, brand = ad_id.split('/')
