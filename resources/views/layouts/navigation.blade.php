<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <!-- Новые кнопки как nav-link -->
                    <x-nav-link :href="route('images.images')" :active="request()->routeIs('images.images')"
                        class="text-gray-900 dark:text-gray-100 hover:text-blue-500 dark:hover:text-blue-400">
                        {{ __('Добавление') }}
                    </x-nav-link>
                    <x-nav-link :href="route('images.imagesM')" :active="request()->routeIs('images.imagesM')"
                        class="text-gray-900 dark:text-gray-100 hover:text-blue-500 dark:hover:text-blue-400">
                        {{ __('Добавление много') }}
                    </x-nav-link>
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <!-- Новые кнопки для мобильной версии -->
            <x-responsive-nav-link :href="route('images.images')" :active="request()->routeIs('images.images')"
                class="text-gray-900 dark:text-gray-100 hover:text-blue-500 dark:hover:text-blue-400">
                {{ __('Добавление') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('images.imagesM')" :active="request()->routeIs('images.imagesM')"
                class="text-gray-900 dark:text-gray-100 hover:text-blue-500 dark:hover:text-blue-400">
                {{ __('Добавление много') }}
            </x-responsive-nav-link>
